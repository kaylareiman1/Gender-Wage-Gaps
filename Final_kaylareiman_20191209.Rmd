...
Acknowledgement: my conceptual work on this project was informed by discussions with classmates Erika Montana and Betty Liu.
...
#Create a version of teh survey dataset that drops observations with missing income
survey.2012 <- nlsy %>%
  filter(income >=0)
...
```{r}
#Defne color palette for gender
gender.palette <- scale_fill_manual(values = c("blue", "violet"))
...
#Plot just people with 2012 income data (including top-coded values)
...
#Create sumamry table of top 2 pct to reference in text chunk below.
top2pct <- survey.2012 %>%
