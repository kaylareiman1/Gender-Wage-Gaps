...
When cleaning the data, each factor was coded to show the  most privileged and/or most common category first. For example, gender was coded with males first so that men are the default category. For race, "Other" is coded first since that includes white people. The exception to this ordered coding is for education, where the lowest level was coded as the baseline. More information about data cleaning is shown in the appendix.
```{r }
